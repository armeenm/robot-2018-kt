...
fun BaseMotorController.configPIDF(pidVals: PIDVals, pidSlot: Int = 0) {
	this.config_kP(pidSlot, pidVals.kP, K_TIMEOUT_MS)
	this.config_kI(pidSlot, pidVals.kI, K_TIMEOUT_MS)
	this.config_kD(pidSlot, pidVals.kD, K_TIMEOUT_MS)
	this.config_kF(pidSlot, pidVals.kF, K_TIMEOUT_MS)
}
